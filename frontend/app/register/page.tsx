    ...
    <div style={styles.container}>
      <div style={styles.formWrapper}>
        ...
        <form onSubmit={handleSubmit}>
          <div style={styles.inputGroup}><label htmlFor="name">Full Name</label><input type="text" id="name" value={name} onChange={(e) => setName(e.target.value)} required style={styles.input}/></div>
        ...
        <p style={styles.linkText}>Already have an account? <Link href="/login" style={styles.link}>Login here</Link></p>
      </div>
    </div>
  );
};
